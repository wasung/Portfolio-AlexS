...
source('~/Portfolio-AlexS/ReproducibleArticleFiles/process-covariates.r')
...
countries <- readRDS('~/Portfolio-AlexS/ReproducibleArticleFiles/regions.rds')
# Read deaths data for regions
d <- readRDS('~/Portfolio-AlexS/ReproducibleArticleFiles/COVID-19-up-to-date.rds')
# Read IFR and pop by country
ifr.by.country <- readRDS('~/Portfolio-AlexS/ReproducibleArticleFiles/popt-ifr.rds')

# Read interventions
interventions <- readRDS('~/Portfolio-AlexS/ReproducibleArticleFiles/interventions.rds')
...
m = stan_model(paste0('~/Portfolio-AlexS/ReproducibleArticleFiles/',StanModel,'.stan'))
...
save(fit,prediction,dates,reported_cases,deaths_by_country,countries,estimated.deaths,estimated.deaths.cf,stan_data, file=paste0('~/Portfolio-AlexS/ReproducibleArticleFiles/Results/',StanModel,'-',JOBID,'-stanfit.Rdata'))
...
ggsave(sprintf("~/Portfolio-AlexS/ReproducibleArticleFiles/%s-mu.png",filename),g,width=4,height=6)
...
ggsave(sprintf("~/Portfolio-AlexS/ReproducibleArticleFiles/%s-final-rt.png",filename),g,width=4,height=6)

print("Generate 3-panel plots")
source("~/Portfolio-AlexS/ReproducibleArticleFiles/plot-3-panel.r")
make_three_panel_plot(filename)

print('Covars plots')
source('~/Portfolio-AlexS/ReproducibleArticleFiles/covariate-size-effects.r')
plot_covars(filename)

print('Making table')
source('~/Portfolio-AlexS/ReproducibleArticleFiles/make-table.r')
make_table(filename)
