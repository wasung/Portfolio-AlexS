...
source('~/Portfolio-AlexS/Opdracht 4 - Reproducible Science/4b - Nature article files/scripts/format-data.r')
...
make_table <- function(filename){
  ...
  write.csv(df_delta[,c('countries', 'text')], file = paste0('~/Portfolio-AlexS/Opdracht 4 - Reproducible Science/4b - Nature article files/Results/deaths-averted-',filename, '.csv'))
  ...
  write.csv(df_null[,c('countries', 'text')], file = paste0('~/Portfolio-AlexS/Opdracht 4 - Reproducible Science/4b - Nature article files/Results/deaths-null-',filename, '.csv'))
  ...
  write.csv(df_model[,c('countries', 'text')], file = paste0('~/Portfolio-AlexS/Opdracht 4 - Reproducible Science/4b - Nature article files/Results/deaths-model-',filename, '.csv'))
  ...
  df_model['text'] <- paste0(df_model[,1]," [",df_model[,2]," - ",df_model[,3],"]")
  df_model <- cbind(df_model, countries)
  write.csv(df_model[,c('countries', 'text')], file = paste0('~/Portfolio-AlexS/Opdracht 4 - Reproducible Science/4b - Nature article files/Results/cases-model-',filename, '.csv'))
  
  df_pop = readRDS('~/Portfolio-AlexS/Opdracht 4 - Reproducible Science/4b - Nature article files/popt-ifr.rds')
  ...
  df_model['text'] <- paste0(df_model[,1]," [",df_model[,2]," - ",df_model[,3],"]")
  df_model <- cbind(df_model, countries)
  write.csv(df_model[,c('countries', 'text')], file = paste0('~/Portfolio-AlexS/Opdracht 4 - Reproducible Science/4b - Nature article files/Results/per-cases-model-',filename, '.csv'))
}