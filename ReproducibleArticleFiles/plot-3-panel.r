...
source("~/Portfolio-AlexS/ReproducibleArticleFiles/geom-stepribbon.r")
#---------------------------------------------------------------------------
make_three_panel_plot <- function(filename){
  
  print(sprintf("loading: %s",paste0("~/Portfolio-AlexS/ReproducibleArticleFiles/Results/",filename,'-stanfit.Rdata')))
  load(paste0("~/Portfolio-AlexS/ReproducibleArticleFiles/Results/", filename,'-stanfit.Rdata'))
  out <- rstan::extract(fit)
  covariates = readRDS('~/Portfolio-AlexS/ReproducibleArticleFiles/interventions.rds')
...
make_plots <- function(data_country, covariates_country_long, 
  ...
  save_plot(filename = paste0("~/Portfolio-AlexS/ReproducibleArticleFiles/figures/", country, "-three-pannel-", filename, ".png"),
            p, base_width = 14)
}
